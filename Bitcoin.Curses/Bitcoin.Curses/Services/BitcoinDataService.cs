...
namespace Bitcoin.Curses.Services
{
    ...
    public class BitcoinDataService : IBitcoinDataService
    {
        ...
        public BitcoinDataService(IDataProvideService dataProvideService, IRateSettingsApplyService rateSettingsApplyService,
            ICustomCurrencySymbolService customCurrencyCodeService, INetworkService networkService, ICacheService cacheService)
        {
        ...
        public async Task<ExchangeRates> GetExchangeRatesAsync(bool force)
        {
            try
            {
                ...
                var bitcoinRateValues = force ? await GetBitcoinRateValues() : await GetBitcoinRateValuesFromCash();
        ...
        private async Task<IDictionary<string, BitcoinExchangeRate>> GetBitcoinRateValuesFromCash()
        {
            try
            {
                return await _cacheService.LoadAsync();
            }
            catch
            {
                return await GetBitcoinRateValues();
            }
        }
        ...
        private async Task<IDictionary<string, BitcoinExchangeRate>> GetBitcoinRateValues()
        {
            try
            {
                ...
                await _cacheService.SaveAsync(bitcoinRateValues);
